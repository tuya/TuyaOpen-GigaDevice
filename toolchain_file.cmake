...
if(WIN32)
    ...
    set(CMAKE_AR "${TOOLCHAIN_DIR}/${CROSS_COMPILE}/bin/ar.exe")
    set(CMAKE_RANLIB "${TOOLCHAIN_DIR}/${CROSS_COMPILE}/bin/ranlib.exe")
    set(CMAKE_STRIP "${TOOLCHAIN_DIR}/${CROSS_COMPILE}/bin/strip.exe")
else()
