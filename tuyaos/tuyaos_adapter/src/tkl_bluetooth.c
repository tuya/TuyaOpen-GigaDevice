...
{
    // --- BEGIN: user implements ---
    tuya_hal_gap_callback_register(gap_evt);
    return OPRT_OK;
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
    tuya_hal_gatt_callback_register(gatt_evt);
    return OPRT_OK;
    // --- END: user implements ---
}
...
OPERATE_RET tkl_ble_gap_address_get(TKL_BLE_GAP_ADDR_T *p_peer_addr)
{
    ...
    if (ble_adp_identity_addr_get(&id_addr) != BLE_ERR_NO_ERROR) {
        return OPRT_RESOURCE_NOT_READY;
    }

    p_peer_addr->type = id_addr.addr_type;
    sys_memcpy(p_peer_addr->addr, id_addr.addr, 6);
...
{
    // --- BEGIN: user implements ---
    return tuya_hal_adv_start(p_adv_params);
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
    return tuya_hal_adv_rsp_data_set(p_adv, p_scan_rsp);
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
    return tuya_hal_adv_rsp_data_update(p_adv, p_scan_rsp);
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
    return tuya_hal_scan_start(p_scan_params);
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
    return tuya_hal_ble_connect(p_peer_addr, p_scan_params, p_conn_params);
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
    return tuya_hal_ble_disconnect(conn_handle, hci_reason);
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
    return tuya_hal_ble_conn_param_update(conn_handle, p_conn_params);
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
    return tuya_hal_ble_rssi_get(conn_handle);
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
    return tuya_hal_ble_name_set(p_name);
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
    return tuya_hal_gatts_service_add(p_service);
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
    return tuya_hal_gatts_value_set(conn_handle, char_handle, p_data, length);
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
    return tuya_hal_gatts_value_notify(conn_handle, char_handle, p_data, length);
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
    return tuya_hal_gatts_value_indicate(conn_handle, char_handle, p_data, length);
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
    return tuya_hal_gattc_all_service_discovery(conn_handle);
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
    return tuya_hal_gattc_all_char_discovery(conn_handle, start_handle, end_handle);
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
    return tuya_hal_gattc_char_desc_discovery(conn_handle, start_handle, end_handle);
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
    return tuya_hal_gattc_write_without_rsp(conn_handle, char_handle, p_data, length);
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
    return tuya_hal_gattc_write(conn_handle, char_handle, p_data, length);;
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
    return tuya_hal_gattc_read(conn_handle, char_handle);
    // --- END: user implements ---
}
