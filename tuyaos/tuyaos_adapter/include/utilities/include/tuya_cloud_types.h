...
/* legacy TuyaOS spelling helpers kept for the GD32 adapter sources */
#ifndef IN
#define IN
#endif
...
#define  TUYA_SDIO_CLK       0x700
#define  TUYA_SDIO_CMD       0x701
#define  TUYA_SDIO_DATA0     0x702
#define  TUYA_SDIO_DATA1     0x703
#define  TUYA_SDIO_DATA2     0x704
#define  TUYA_SDIO_DATA3     0x705
...
typedef struct {
	...
	uint32_t freq_hz;       /**< QSPI controller clock divide number */
...
/**
 * @brief I2S Mode
 * USE  4 TYPES, MASTER TX,MASTER RX,SLAVE TX,SLAVE RX,
 */
typedef enum {
