...
typedef void (*model_func)(const struct bt_mesh_model *mod, const struct bt_mesh_elem *elem,
					bool vnd, bool primary,
					void *user_data);

typedef void (*mesh_msg_cb)(uint32_t opcode, struct bt_mesh_msg_ctx *ctx, struct net_buf_simple *buf);

typedef enum bt_mesh_walk (*mesh_walk_cb)(const struct bt_mesh_model *mod, void *user_data);
...
void bt_mesh_model_extensions_walk(const struct bt_mesh_model *root, mesh_walk_cb cb, void *user_data);
