...
struct bt_mesh_subnet {
	...
	struct priv_beacon_ctx priv_beacon_ctx;
#endif
...
#else
#define SUBNET_CB_SECTION __attribute__((section(".MESH_SUBNET_CBS"))) __attribute__((aligned(4))) __attribute__((used))
#define BT_MESH_SUBNET_CB_DEFINE(_name)                                    \
	static const struct bt_mesh_subnet_cb bt_mesh_subnet_cb_ ## _name SUBNET_CB_SECTION
#endif
