...
#define SLOT_ENTRY_BUFLEN 17

#define DFU_SLOT_SETTINGS_PATH "dfu/slot"
...
static struct settings_handler_static settings_handler_bt_mesh_dfu_slots = {
	.name = DFU_SLOT_SETTINGS_PATH,
	.h_get = NULL,
	.h_set = slot_data_load,
	.h_commit = NULL,
	.h_export = NULL,
	.next = NULL,
};

void bt_mesh_dfu_slot_settings_init(void)
{
	bt_mesh_settings_cb_register(&settings_handler_bt_mesh_dfu_slots);
}
#else
