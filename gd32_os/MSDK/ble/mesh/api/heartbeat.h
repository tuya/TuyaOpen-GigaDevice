...
#else
#define HB_CB_SECTION __attribute__((section(".MESH_HB_CBS"))) __attribute__((aligned(4))) __attribute__((used))
#define BT_MESH_HB_CB_DEFINE(_name)                                            \
	static const struct bt_mesh_hb_cb bt_mesh_hb_cb_ ## _name HB_CB_SECTION
#endif
