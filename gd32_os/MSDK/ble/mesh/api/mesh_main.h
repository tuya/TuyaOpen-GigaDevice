...
#else
#define LPN_CB_SECTION __attribute__((section(".MESH_LPN_CBS"))) __attribute__((aligned(4))) __attribute__((used))
#define BT_MESH_LPN_CB_DEFINE(_name)                            \
  static const struct bt_mesh_lpn_cb bt_mesh_lpn_cb_ ## _name LPN_CB_SECTION
#endif
...
#else
#define FRIEND_CB_SECTION __attribute__((section(".MESH_FRIEND_CBS"))) __attribute__((aligned(4))) __attribute__((used))

#define BT_MESH_FRIEND_CB_DEFINE(_name)                                  \
  static const struct bt_mesh_friend_cb bt_mesh_friend_cb_ ## _name FRIEND_CB_SECTION
#endif
...
#else
#define BEACON_CB_SECTION __attribute__((section(".MESH_BEACON_CBS"))) __attribute__((aligned(4))) __attribute__((used))
#define BT_MESH_BEACON_CB_DEFINE(_name)                                  \
  static const struct bt_mesh_beacon_cb bt_mesh_beacon_cb_ ## _name BEACON_CB_SECTION
#endif
#endif
