...
typedef struct _coeff_div {
	...
	uint32_t mclk;
	uint32_t rate;
	uint8_t	Reg0x04;	//按照实际可调
	uint8_t	Reg0x05;	//按照实际可调
	uint8_t	Reg0x06;	//按照实际可调
	uint8_t	Reg0x07;	//按照实际可调
	uint8_t	Reg0x08;	//按照实际可调
	uint8_t	Reg0x09;	//按照实际可调
	uint8_t	Reg0x0A;	//按照实际可调
	uint8_t	Reg0x0B;	//按照实际可调
	uint8_t	Reg0x19;	//按照实际可调
	uint8_t	dvdd_vol;	//固定模板	2：1V8&3V3,		1：3V3,		0：1V8
	uint8_t	dmic_sel;	//固定模板	2：AMIC&DMIC,	1：DMIC,	0：AMIC
} _coeff_div;
