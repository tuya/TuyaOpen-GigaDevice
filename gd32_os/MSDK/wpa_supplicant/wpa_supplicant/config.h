...
/* GD modify */
#else
static inline int wpa_config_get_value(const char *name, struct wpa_config *config,
			 char *buf, size_t buflen)
{
	return -1;
}
...
void wpa_config_set_sae_pwe(struct wpa_config *config, int sae_pwe); /* GD modify */
