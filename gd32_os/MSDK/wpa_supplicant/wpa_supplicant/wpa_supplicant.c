...
struct wpa_global *g_wpa_global; /* GD modify */
#endif
...
/* GD modify */
#ifdef CONFIG_GDWIFI
	// do not scan, triger wifi management to reconnect.
	wifi_wpa_send_event_with_name(WIFI_WPA_PROCESS_ERROR,
						(void *)WIFI_WPA_ERROR_OTHERS,
						0, wpa_s->ifname);
#else
/* GD modify end */
				       ...
				       struct wpa_ssid *ssid)
{
	...
	if (ssid->key_mgmt & WPA_KEY_MGMT_WPS)
		wpa_s->key_mgmt = WPA_KEY_MGMT_WPS;
#ifdef IEEE8021X_EAPOL /* GD modify */
	else if (ssid->key_mgmt & WPA_KEY_MGMT_IEEE8021X_NO_WPA)
		wpa_s->key_mgmt = WPA_KEY_MGMT_IEEE8021X_NO_WPA;
#endif /* IEEE8021X_EAPOL */ /* GD modify */
	else
		wpa_s->key_mgmt = WPA_KEY_MGMT_NONE;
...
static void wpa_supplicant_cleanup(struct wpa_supplicant *wpa_s)
{
...
#ifdef PCSC_FUNCS /* GD modify */
	scard_deinit(wpa_s->scard);
	wpa_s->scard = NULL;
#endif /* PCSC_FUNCS */ /* GD modify */
...
#ifndef CONFIG_NO_CONFIG_WRITE /* GD modify */
	os_free(wpa_s->confname);
	wpa_s->confname = NULL;

	os_free(wpa_s->confanother);
	wpa_s->confanother = NULL;
#endif /* CONFIG_NO_CONFIG_WRITE */ /* GD modify */
...
#ifndef CONFIG_NO_RAND_ADDR /* GD modify */
	wpas_mac_addr_rand_scan_clear(wpa_s, MAC_ADDR_RAND_ALL);
#endif /* CONFIG_NO_RAND_ADDR */ /* GD modify */

#ifdef CONFIG_GAS /* GD modify */
	/*
	...
	wpa_s->gas = NULL;
#endif /* CONFIG_GAS */ /* GD modify */

#ifdef CONFIG_GAS_SERVER /* GD modify */
	gas_server_deinit(wpa_s->gas_server);
	wpa_s->gas_server = NULL;
#endif /* CONFIG_GAS_SERVER */ /* GD modify */
...
#ifdef CONFIG_EXT_PASSWORD /* GD modify */
	ext_password_deinit(wpa_s->ext_pw);
	wpa_s->ext_pw = NULL;
#endif /* CONFIG_EXT_PASSWORD */ /* GD modify */

#ifdef CONFIG_INTERWORKING /* GD modify */
	wpabuf_free(wpa_s->last_gas_resp);
	wpa_s->last_gas_resp = NULL;
	wpabuf_free(wpa_s->prev_gas_resp);
	wpa_s->prev_gas_resp = NULL;
#endif /* CONFIG_INTERWORKING */ /* GD modify */
...
#ifdef CONFIG_VENDER_ELEM /* GD modify */
	for (i = 0; i < NUM_VENDOR_ELEM_FRAMES; i++) {
		wpabuf_free(wpa_s->vendor_elem[i]);
		wpa_s->vendor_elem[i] = NULL;
	}
#endif /* CONFIG_VENDER_ELEM */ /* GD modify */

#ifndef CONFIG_NO_WMM_AC
	wmm_ac_notify_disassoc(wpa_s);
#endif /* CONFIG_NO_WMM_AC */

#ifndef CONFIG_NO_PNO_OR_SCHE_SCAN /* GD modify */
	wpa_s->sched_scan_plans_num = 0;
	os_free(wpa_s->sched_scan_plans);
	wpa_s->sched_scan_plans = NULL;
#endif /* CONFIG_NO_PNO_OR_SCHE_SCAN */ /* GD modify */
...
#endif /* IEEE8021X_EAPOL */
#ifdef CONFIG_WPS /* GD modify */
		wpa_s->after_wps = 0;
		wpa_s->known_wps_freq = 0;
		wpas_p2p_completed(wpa_s);
#endif /* CONFIG_WPS */ /* GD modify */
...
/* GD modify */
#ifdef CONFIG_GDWIFI
		if ((old_state == WPA_ASSOCIATED) && (state == WPA_DISCONNECTED))
			wpa_drv_set_operstate(wpa_s, 2);
		else if ((old_state == WPA_COMPLETED) && (state == WPA_ASSOCIATING))
			wpa_drv_set_operstate(wpa_s, 3);
		else
...
{
	struct wpa_config *conf = NULL; /* GD modify */
	int reconf_ctrl;
	int old_ap_scan;
...
#ifdef CONFIG_MBO /* GD modify */
		if ((wpas_driver_bss_selection(wpa_s) ||
		     !wpa_s->disable_mbo_oce) &&
		    !wpa_s->conf->disable_btm)
			*pos |= 0x08; /* Bit 19 - BSS Transition */
#endif /* CONFIG_MBO */ /* GD modify */
#endif /* CONFIG_WNM */
		break;
	case 3: /* Bits 24-31 */
#ifdef CONFIG_WNM
...
#ifdef CONFIG_IBSS_MESH_SUPPORT /* GD modify */
...
#endif /* CONFIG_IBSS_MESH_SUPPORT */ /* GD modify */
...
#ifndef CONFIG_NO_EDMG_SUPPORT /* GD modify */
...
#endif /* CONFIG_NO_EDMG_SUPPORT */ /* GD modify */
...
#ifdef CONFIG_P2P /* GD modify */
	params.p2p = ssid->p2p_group;

	if (wpa_s->p2pdev->set_sta_uapsd)
		params.uapsd = wpa_s->p2pdev->sta_uapsd;
	else
#endif /* CONFIG_P2P */ /* GD modify */
		params.uapsd = -1;
...
int wpa_supplicant_driver_init(struct wpa_supplicant *wpa_s)
{
	...
	wpa_s->prev_scan_wildcard = 1; // 0 /* GD modify */
...
#ifdef CONFIG_GDWIFI
	wpa_s->conf->wps_cred_processing = 1; /* GD modify */
#endif
...
#ifndef CONFIG_NO_RRM /* GD modify */
		wpa_s->drv_rrm_flags = capa.rrm_flags;
#endif /* CONFIG_NO_RRM */ /* GD modify */
...
#ifdef CONFIG_GDWIFI
	wpa_s->auto_reconnect_disabled = 1; /* GD modify */
#endif
...
#ifdef CONFIG_GDWIFI
    wifi_wpa_send_event_with_name(WIFI_WPA_PROCESS_ERROR, /* GD modify */
                        (void *)WIFI_WPA_ERROR_OTHERS,
                        0, wpa_s->ifname);
#else
