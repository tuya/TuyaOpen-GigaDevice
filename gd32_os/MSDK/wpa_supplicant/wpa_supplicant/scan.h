...
/* GD modify */
#else /* CONFIG_NO_PNO_OR_SCHE_SCAN */
static inline int wpa_supplicant_delayed_sched_scan(struct wpa_supplicant *wpa_s,
				      int sec, int usec)
{
	return -1;
}
static inline int wpa_supplicant_req_sched_scan(struct wpa_supplicant *wpa_s)
{
	return -1;
}
static inline void wpa_supplicant_cancel_delayed_sched_scan(struct wpa_supplicant *wpa_s)
{
}
static inline void wpa_supplicant_cancel_sched_scan(struct wpa_supplicant *wpa_s)
{
}
#endif /* CONFIG_NO_PNO_OR_SCHE_SCAN */
