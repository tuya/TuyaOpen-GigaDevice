...
static inline void wpas_notify_mac_address_changed(struct wpa_supplicant *wpa_s)
{
}
...
static inline void wpas_notify_psk_mismatch(struct wpa_supplicant *wpa_s)
{
}
...
static inline void wpas_notify_pmk_cache_added(struct wpa_supplicant *wpa_s,
							struct rsn_pmksa_cache_entry *entry)
{
}
#endif /* CONFIG_NOTIFY */
