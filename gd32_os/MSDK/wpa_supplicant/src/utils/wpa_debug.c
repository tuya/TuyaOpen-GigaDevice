...
#ifndef _WIN32
	setvbuf(out_file, NULL, _IONBF, 0); /* GD modify */
#endif /* _WIN32 */
#else /* CONFIG_DEBUG_FILE */
	(void)path;
#endif /* CONFIG_DEBUG_FILE */
...
{
#ifndef _WIN32
	setvbuf(stdout, NULL, _IONBF, 0); /* GD modify */
#endif /* _WIN32 */
}
...
/* GD modify */
void wpa_debug_level_set(uint32_t level)
{
    wpa_debug_level = (level > MSG_ERROR) ? MSG_ERROR : level;
}

uint32_t wpa_debug_level_get(void)
{
