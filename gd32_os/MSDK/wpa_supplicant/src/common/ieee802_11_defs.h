...
#define MULTI_BSSID_ID_OFT                  0
#define MULTI_BSSID_LEN_OFT                 1
#define MULTI_BSSID_MAX_INDICATOR_OFT       2
#define MULTI_BSSID_SUB_IES_OFT             3
#define MULTI_BSSID_ELMT_MIN_LEN            4
#define MULTI_BSSID_MIN_LEN                 6

///Maximum number of nonTxed BSSID information we can store for one received beacon
#define MAX_NONTXED_BSSID_PER_BEACON        16

/// Nontransmitted BSSID profile
#define MBSSID_NON_TXED_PROF_ID_OFT         0
#define MBSSID_NON_TXED_PROF_LEN_OFT        1
#define MBSSID_NON_TXED_PROF_INFO_OFT       2
#define MBSSID_NON_TXED_PROF_ELMT_MIN_LEN   4
#define MBSSID_NON_TXED_PROF_MIN_LEN        6

// Nontransmitted BSSID capabilities IE - 83
#define NON_TXED_BSSID_CAPA_ID_OFT          0
#define NON_TXED_BSSID_CAPA_LEN_OFT         1
#define NON_TXED_BSSID_CAPA_OFT             2
#define NON_TXED_BSSID_CAPA_LEN             4

// Multiple BSSID Index IE - 85
#define MULTI_BSSID_INDEX_ID_OFT            0
#define MULTI_BSSID_INDEX_LEN_OFT           1
#define MULTI_BSSID_INDEX_OFT               2
#define MULTI_BSSID_DTIM_PERIOD_OFT         3
#define MULTI_BSSID_DTIM_COUNT_OFT          4
#define MULTI_BSSID_INDEX_MIN_LEN           3
/* GD modify end */
