...
#ifdef CONFIG_FFC_GROUP_SUPPORT /* GD modify */
...
#endif /* CONFIG_FFC_GROUP_SUPPORT */ /* GD modify */
	/* Unsupported group */
...
#ifdef CONFIG_FFC_GROUP_SUPPORT /* GD modify */
	crypto_bignum_deinit(tmp->pwe_ffc, 1); /* GD modify */
		       ...
		       struct sae_data *sae)
{
	if (sae->tmp == NULL ||
#ifdef CONFIG_FFC_GROUP_SUPPORT /* GD modify */
	    (sae->tmp->dh && sae_derive_pwe_ffc(sae, addr1, addr2, password, /* GD modify */
						password_len) < 0) ||
#endif /* GD modify */
	    (sae->tmp->ec && sae_derive_pwe_ecc(sae, addr1, addr2, password, /* GD modify */
						password_len) < 0))
		return -1;
