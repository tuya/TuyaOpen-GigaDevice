...
#else
	wpa_printf(MSG_DEBUG, "Add associated STA " MACSTR
		   " (added_unassoc=%d auth_alg=%u reassoc=%d authorized=%d)",
		   MAC2STR(sta->addr), sta->added_unassoc, sta->auth_alg,
...
#ifndef CONFIG_AP_NO_40MHZ_AND_MORE /* GD modify */
...
#endif /* CONFIG_AP_NO_40MHZ_AND_MORE */ /* GD modify */
#ifdef CONFIG_DPP
