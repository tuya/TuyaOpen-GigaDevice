...
#ifndef CONFIG_AP_NO_MBSSID /* GD modify */
static int
...
#endif /* CONFIG_AP_NO_MBSSID */ /* GD modify */
...
#ifndef CONFIG_AP_NO_RNR /* GD modify */
	if (!params->is_ml_sta_info)
		buflen += hostapd_eid_rnr_len(hapd, WLAN_FC_STYPE_PROBE_RESP,
					      true);
#endif /* CONFIG_AP_NO_RNR */ /* GD modify */
...
#ifndef CONFIG_AP_NO_CSA /* GD modify */
	/*
	 * CSA IE
...
#endif /* CONFIG_AP_NO_CSA */ /* GD modify */
...
#ifndef CONFIG_AP_NO_FT
	pos = hostapd_get_mde(hapd, pos, epos - pos);
#endif /* CONFIG_AP_NO_FT */ /* GD modify */
...
#ifdef CONFIG_WNM_AP /* GD modify */
	pos = hostapd_eid_time_adv(hapd, pos);
	pos = hostapd_eid_time_zone(hapd, pos);
#endif /* CONFIG_WNM_AP */ /* GD modify */
...
#ifdef CONFIG_IEEE80211AX
#ifndef CONFIG_AP_NO_5GHZ_AND_MORE /* GD modify */
	if (hapd->iconf->ieee80211ax && !hapd->conf->disable_11ax &&
	    is_6ghz_op_class(hapd->iconf->op_class))
		pos = hostapd_eid_txpower_envelope(hapd, pos);
#endif /* CONFIG_AP_NO_5GHZ_AND_MORE */
#endif /* CONFIG_IEEE80211AX */
...
#define BEACON_TAIL_BUF_SIZE 512
	...
	*pos++ = WLAN_EID_SSID;
	...
	tailpos = hostapd_eid_rm_enabled_capab(hapd, tailpos,
					       tailend - tailpos);
#endif /* CONFIG_NO_RRM */ /* GD modify */
#ifndef CONFIG_AP_NO_FT /* GD modify */
	...
	if (hapd->iconf->ieee80211ax && !hapd->conf->disable_11ax &&
	    is_6ghz_op_class(hapd->iconf->op_class))
		tailpos = hostapd_eid_txpower_envelope(hapd, tailpos);
#endif /* CONFIG_AP_NO_5GHZ_AND_MORE */ /* GD modify */
#endif /* CONFIG_IEEE80211AX */
...
#ifndef CONFIG_AP_NO_CSA /* GD modify */ /* GD modify */
	if (hapd->csa_in_progress) {
		wpa_printf(MSG_ERROR, "Cannot set beacons during CSA period");
		return -1;
	}
#endif /* CONFIG_AP_NO_CSA */ /* GD modify */ /* GD modify */
