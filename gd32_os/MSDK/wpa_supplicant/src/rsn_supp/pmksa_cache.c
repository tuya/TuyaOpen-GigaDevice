...
#if defined(IEEE8021X_EAPOL) && !defined(CONFIG_NO_WPA) || defined(CONFIG_WPA3_PMK_CACHE_ENABLE) /* GD modify */
...
#endif /* IEEE8021X_EAPOL && !CONFIG_NO_WPA || CONFIG_WPA3_PMK_CACHE_ENABLE */
