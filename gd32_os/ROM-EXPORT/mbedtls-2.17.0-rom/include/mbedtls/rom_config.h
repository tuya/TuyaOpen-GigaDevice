...
#ifndef MBEDTLS_ROM_CONFIG_H
#define MBEDTLS_ROM_CONFIG_H

#if defined(_MSC_VER) && !defined(_CRT_SECURE_NO_DEPRECATE)
#define _CRT_SECURE_NO_DEPRECATE 1
#endif

extern unsigned int sys_get_time(void *p);
...
////#define MBEDTLS_PLATFORM_STD_CALLOC        sys_calloc /**< Default allocator to use, can be undefined */
////#define MBEDTLS_PLATFORM_STD_FREE            sys_mfree /**< Default free to use, can be undefined */
//#define MBEDTLS_PLATFORM_STD_EXIT            exit /**< Default exit to use, can be undefined */
////#define MBEDTLS_PLATFORM_STD_TIME            sys_get_time /**< Default time to use, can be undefined. MBEDTLS_HAVE_TIME must be enabled */
